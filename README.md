...
```
npm create cloudflare@latest -- --template=cloudflare/templates/cool-rice-618c
```

A live public deployment of this template is available at [https://cool-rice-618c.templates.workers.dev](https://cool-rice-618c.templates.workers.dev)
